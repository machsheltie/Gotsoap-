...
1. `gotsoap/docs/copy/copy-contract-for-build.md` — **start here.** Rules of engagement + the ⚡ CHANGE LOG at the top.
2. `gotsoap/docs/copy/voice-bible.md` — the register. Read before writing/altering any string.
...
4. `gotsoap/docs/copy/launch-campaign-v1.md` — social/GTM + the §2A conversion strategy. Post-launch, not build-blocking, but the §2A "never a roast without a visible door" rule constrains verdict-page layout.
5. `gotsoap/docs/asset-brief.md` — owner's Photoshop deliverables + the **placeholder strategy** (build does not block on final art).

## What changed since the PRD/design.md snapshot
1. **All copy is voice-forward and FROZEN** in `../../../docs/copy/copy-deck-v2.md`. Build from it verbatim; do not paraphrase or invent strings.
...
- If any string needs changing: edit `../../../docs/copy/copy-deck-v2.md` first, then update `copy.ts` — never edit strings straight into components.
