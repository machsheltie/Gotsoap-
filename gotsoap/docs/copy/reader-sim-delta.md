...
**Vector 2 (woman → man) — F1, deliberately deferred to `../../../cwaaa/docs/copy/vector2-citation-path-spec.md`.** Maya, blind,
...
1. **Build the vector-2 citation path** (`../../../cwaaa/docs/copy/vector2-citation-path-spec.md`) — now the validated #1 gap.
...
convergence MOVED to **"a protest in punchlines"** — but that is Stacey's own `gotsoap/sources/promo.txt` phrase
