...
**They must not see:** `../../../docs/copy/copy-correction-plan.md`, the dialectic rounds, `CAMPAIGN-INTENT.md`, the
...
- **Vector 2 (woman → man) is still broken.** F1 was deliberately deferred to
  `../../../cwaaa/docs/copy/vector2-citation-path-spec.md`. If Maya says again that she has no way to send it to a man, that
...
Write the delta to `gotsoap/docs/copy/reader-sim-delta.md`: per baseline finding, **moved / didn't move /
