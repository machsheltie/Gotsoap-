...
```
  ...
  │       → gotsoap/docs/copy/research-satirical-campaigns.md   (cited; the neutral argument base)
  │
  ├─ 2. READER EVIDENCE (Opus dispatches gotsoap-readers, BLIND)
  │       → gotsoap/docs/copy/reader-sim-evidence.md            ✅ 2026-07-17 baseline done
  │
  ├─ 3. ADVERSARIAL AUDIT (Sol) — every string vs the standard, ranked, with a "what's missing"
  │       → gotsoap/docs/copy/copy-review-findings.md
  │
...
| 5 | **Plan + implement** — into `copy.ts` / deck / style-lock | Fable (copy lane) | `../../../docs/copy/copy-correction-plan.md` | after 4 |
...
- **The standard:** `gotsoap/docs/copy/CAMPAIGN-INTENT.md` · `voice-bible.md` · `style-lock.md`
- **The evidence:** `gotsoap/docs/copy/reader-sim-evidence.md`
- **The order (work list + protocol detail):** `gotsoap/docs/build/reports/copy-review-order.md`
...
- **The origin texts:** `gotsoap/sources/promo.txt` · `gotsoap/sources/gotsoapdescription.txt` (repo root)
