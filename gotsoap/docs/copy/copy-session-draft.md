...
- `gotsoap/docs/copy/style-lock.md` written — 9 locked decisions, including Sol's boundary on when plain chrome is permitted (structural + format-supplied context + revoicing would misdescribe).
