...
2. `gotsoap/docs/build/PROTOCOL.md` — how this loop works and who owns what.
...
3. You have manually verified the phase at **390 × 844** before any desktop polish.
   ...
   lazy layout hides.
4. You have written `gotsoap/docs/build/reports/phase-N-build.md`.
...
`gotsoap/docs/build/reports/phase-1-build.md` and stop. Do not start Phase 2.
...
// → gotsoap/docs/build/reports/evidence/phase2-neutral-<slug>.png   (all five)
```
...
**Then write `gotsoap/docs/build/reports/phase-2a-build.md` and STOP.** Do not begin desktop.
...
4. **Copy floor — `npm run copy-gates` must be green.** The §7.2 corrections and every
   ...
   (`gotsoap/docs/build/PROMPT-COPY.md`), not yours to write — but launch cannot ship with it red,
...
## BUILD REPORT TEMPLATE — `gotsoap/docs/build/reports/phase-N-build.md`
