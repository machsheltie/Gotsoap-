...
2. `gotsoap/docs/build/PROTOCOL.md` — the loop.
3. `gotsoap/docs/build/reports/phase-N-build.md` — Fable's account of what it did. Treat this as the *claim under audit*, not as evidence.
...
- You **write only** to `gotsoap/docs/build/reports/phase-N-review.md`.
...
different easing. Look at the *screenshots* in `gotsoap/docs/build/reports/evidence/` and answer
...
A documented recurring defect (`gotsoap/docs/build/reports/visual-redo-brief.md`): display glyphs
...
Fable has finished Phase N and written `gotsoap/docs/build/reports/phase-N-build.md`.
...
2. Read `specs.md` §§ for this phase (see `gotsoap/docs/build/PROTOCOL.md` for the mapping).
...
6. Write `gotsoap/docs/build/reports/phase-N-review.md` in the format below.
...
### Review format — `gotsoap/docs/build/reports/phase-N-review.md`
...
`gotsoap/docs/build/reports/phase-N-remediation.md`. It is mandatory, not ceremonial.
...
3. **Is everything deferred forward actually OWNED by a later phase** in
   `gotsoap/docs/build/PROTOCOL.md`? Check the table. **"A later phase will fix it" that no
...
Append to `gotsoap/docs/build/reports/phase-N-review.md`:
