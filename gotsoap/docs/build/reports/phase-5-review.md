...
- The G7c waiver is legitimate, not Phase 5 laundering. Its failing reference is the canonical-poster wash in `site/src/components/homev2/Campaign.astro:39-54`, and `gotsoap/docs/build/reports/visual-redo-brief.md` assigns that home defect to the active home-redo workstream. Neither Phase 5 source file introduced it.
...
Deferred-to-nowhere: none. G7c remains explicitly owned by `gotsoap/docs/build/reports/visual-redo-brief.md`; the real Phase 5 composite remains an owner asset and ship blocker in `gotsoap/docs/build/PROTOCOL.md:95,138`.
...
Deferred-to-nowhere: none. G7c remains owned by the home-redo brief; the real placement composites remain the explicit owner asset and Phase 5 ship blocker in `gotsoap/docs/build/PROTOCOL.md:95,138`.
