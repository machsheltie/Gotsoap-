...
**Spec:** `gotsoap/docs/build/reports/footer-consolidation-spec.md`.
...
- **`gotsoap/docs/copy/style-lock.md`** — §7 kill list gains the spec-campaign tell (campaign
...
6. **Viewports:** verified at 390×844 and 1440×900 (screenshots under
   `gotsoap/docs/build/reports/assets/footer-consolidation/`). At 390 the flanks are hidden by
