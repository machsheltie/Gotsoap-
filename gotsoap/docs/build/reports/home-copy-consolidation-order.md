...
Paste with the **Standing Brief** from `gotsoap/docs/build/PROMPT-FABLE.md`. This is the copy/register
...
**Read first:** `gotsoap/docs/build/reports/footer-consolidation-spec.md` — the full spec. This order is the
