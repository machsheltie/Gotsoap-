...
Paste this **after** the Standing Brief in `gotsoap/docs/build/PROMPT-SOL.md`.

---

Fable has completed **Phase 1 (hygiene sweep)** and written
`gotsoap/docs/build/reports/phase-1-build.md`. Audit it.
...
Write `gotsoap/docs/build/reports/phase-1-review.md` in the Standing Brief's format.
