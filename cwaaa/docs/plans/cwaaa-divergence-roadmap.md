...
Portable institutional material remains inside its own package: CWAAA under `cwaaa/docs/` and the
Office under `office-of-lather-compliance/docs/`. Shared facts travel by explicit reference from
