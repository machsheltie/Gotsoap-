...
Deferred-to-nowhere: none. G7c remains pre-existing home-wash debt owned by `gotsoap/docs/build/reports/visual-redo-brief.md`; this remediation is confined to `site/src/components/cwaaa/CrisisReport.astro` and does not touch that surface.
